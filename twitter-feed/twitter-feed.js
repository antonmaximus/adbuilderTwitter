...
/*jshint validthis: true */
        ...
        function TwitterFeedComp(properties) {
            graphicComp.call(this, properties);    
        }

        TwitterFeedComp.prototype = new graphicComp();

        TwitterFeedComp.prototype.internalDraw = function() {
            ...
            domUtils.bindEvent(this.div.querySelector('#sz-placeholderImage'), 'click', function() {
                insertTwitterWidgetAndScriptToDOM.call(this);
                EB.userActionCounter("FacebookFeedClicked");
            }.bind(this));
        };
    
        TwitterFeedComp.getInputSchema = function(){
            return TwitterFeedComp.inputSchema;
        };

        TwitterFeedComp.inputSchema = objectUtils.create(graphicComp.inputSchema,{
        ...
        function insertTwitterWidgetAndScriptToDOM() {
