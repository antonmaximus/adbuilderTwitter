define(['comp/graphicComp', 'utils/domUtils', 'utils/objectUtils'],
    ...
    function(graphicComp, domUtils, objectUtils) {
        ...
        function drawTwitterFeed() {
            ...
            this.div.innerHTML = buildTemplate.call(this, _templates.tweet, {
